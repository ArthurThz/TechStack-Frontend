...
const Header = () => {
  return (
    <header className="absolute px-4 md:px-10 h-24 w-full top-0 right-0 left-0 flex flex-row items-center justify-between bg-transparent">
      <div className="flex gap-4 flex-row items-center px-1 md:px-5 justify-center">
        <Image src="/wifi-icon.svg" width={30} height={30} alt="wifi icon" />
