...
const WelcomeCard = ({ content, icon }: CardProps) => {
  return (
    <div className="w-[300px] h-[300px] ring-2 py-10 px-4 gap-10 ring-green-haze-500 flex flex-col items-center text-center rounded-md shadow-sm shadow-green-haze-500 group hover:shadow-lg hover:shadow-green-haze-500 transition-all hover:scale-105">
