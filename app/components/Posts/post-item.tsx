...
const PostItem = ({
  ...
  return (
    <div className="w-full h-auto px-4 py-10 flex flex-col gap-5 items-center border border-green-haze-500 rounded-md">
      <div className="w-full items-start flex md:flex-row gap-8 md:items-center text-green-haze-500 font-medium">
        <Image
          alt="profile pic"
        ...
        <div className="flex flex-col gap-2 items-start">
          ...
          <p className="text-green-haze-500/80 text-sm">Front End Developer</p>
        </div>
      </div>
      <h1 className="text-green-haze-500 font-medium text-2xl">{title}</h1>
      <div className="h-[1px] w-[80%] border border-zinc-400/10" />
      <div className="w-full h-full  text-sm px-2 md:px-4 text-white md:text-md font-light text-justify ">
        {content}
      </div>
