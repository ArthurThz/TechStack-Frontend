...
const Input = ({label, name, onChange,type,disabled,placeholder}:IInput) => {
  return (
    <div className='w-full flex flex-col rounded-md h-auto'>
        ...
        <input className='min-w-[70%] border border-woodsmoke-950 outline-none disabled:bg-transparent disabled:border-green-haze-500 bg-woodsmoke-700 text-white h-12 rounded-md px-2 focus-within:outline-green-haze-500 '
