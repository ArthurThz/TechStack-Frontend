...
const SignUp = () => {
  return (
    <div className="w-full min-h-screen flex items-center justify-center">
      <div className="w-[85%] h-auto p-5 ring-2 ring-green-haze-500/30 flex flex-col gap-2 items-center rounded-lg shadow-lg shadow-green-haze-400/30 md:py-5  md:px-10 lg:w-[60%] lg:p-10 lg:flex-row lg:justify-center lg:h-[70%] lg:gap-6">
